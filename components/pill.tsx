...
export const Pill = ({ children, className }: { children: React.ReactNode, className?: string }) => {
  ...
  return (
    <div
      ...
      className={cn("bg-[#00ff9d]/10 transform-gpu font-medium text-[#00ff9d] backdrop-blur-xs font-mono text-sm inline-flex items-center justify-center px-3 h-8  border border-[#00ff9d]/50 [clip-path:polygon(var(--poly-roundness)_0,calc(100%_-_var(--poly-roundness))_0,100%_var(--poly-roundness),100%_calc(100%_-_var(--poly-roundness)),calc(100%_-_var(--poly-roundness))_100%,var(--poly-roundness)_100%,0_calc(100%_-_var(--poly-roundness)),0_var(--poly-roundness))]", className)}
    >
      ...
      <span className="inline-block size-2.5 rounded-full bg-[#00ff9d] mr-2 shadow-glow shadow-[#00ff9d]/50" />
